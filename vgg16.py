...
from tensorflow import keras
model = keras.models.load_model('/content/ODIR_VGG16.keras')
from PIL import Image
import numpy as np
from skimage.segmentation import mark_boundaries
import matplotlib.pyplot as plt
...
test_image_array = np.array(Image.open(image_path).resize((224, 224))) # Resize when loading
...
plt.imshow(mark_boundaries(input_img[0], mask))
